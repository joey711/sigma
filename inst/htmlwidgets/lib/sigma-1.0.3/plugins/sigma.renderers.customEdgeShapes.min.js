...
function() {
    ...
    grd2.addColorStop(0,source.color); 
    grd2.addColorStop(1,target.color);

    var grd3=context.createLinearGradient(sX,sY,tX,tY);
    grd3.addColorStop(0,source.color); 
    grd3.addColorStop(1,target.color);
...
function() {
  ...
  sigma.canvas.edges.tapered = function(edge, source, target, context, settings) {
    ...
    grd.addColorStop(0,source.color); 
    grd.addColorStop(0.5,target.color); 
    grd.addColorStop(1,target.color);
